...
void Balance::pwma(double speedoutput,float rotationoutput,float angle,int turnleftflag,int turnrightflag,
	int f,int b,int Pin1,int Pin2,int Pin3,int Pin4,int PinPWMA,int PinPWMB)
{
  // angleoutput balance   gyro_x angle
  // speedoutput forward/backward   pulse
  // rotationoutput turn left/right    gyro_z pulse
  ...
  //   if(pulseleft + pulseright> 1500||pulseleft + pulseright <- 1500){
  //     pwm1 = 0;
  //     pwm2 = 0;
  //     flag1=1;
  //   }
  ...
  //   flag1=0;
  // }
  // if (turnleftflag == 0 && turnrightflag == 0){
  //   if(pulseleft + pulseright> 500||pulseleft + pulseright <- 500){
  //   pwm1 = 0;
  //   pwm2 = 0;
  //   flag1=1;
  //   }
